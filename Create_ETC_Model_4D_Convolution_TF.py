...
#-------------------------Convolution-TF Layer Imports------------------------#

from Convolution_Layer_TF_TF2 import Convolution_Layer_TF

#--------------------Convolution-Transpose TF Layer Imports-------------------#

from Convolution_Layer_Transpose_TF_TF2 import Convolution_Layer_Transpose_TF
...
def Create_ETC_Model_4D_Functional_API(Input_Size,Start_Neurons,Number_of_Classes):
    ...
    from Create_ETC_Model_4D_Convolution_TF import Create_ETC_Model_4D_Parameter_Generation
...
#-------------------------Encoder-1st Stack of Layers-------------------------#
    ...
    Encoder_1st_Stack=Convolution_Layer_TF(Tensor_Order=4,
                                           Convolution_Subsection=Convolution_Shape_Encoder,
                                           Filter_Size=Filter_Size_Convolution_Encoder,
                                           Number_of_Filters=Number_of_Filters_Convolution_Encoder_1st_Stack,
                                           Convolution_Strides=Strides_Convolution_Encoder,
...
#-------------------------Encoder-2nd Stack of Layers-------------------------#
    ...
    Encoder_2nd_Stack=Convolution_Layer_TF(Tensor_Order=4,
                                           Convolution_Subsection=Convolution_Shape_Encoder,
                                           Filter_Size=Filter_Size_Convolution_Encoder,
...
#-------------------------Encoder-3rd Stack of Layers-------------------------#
    ...
    Encoder_3rd_Stack=Convolution_Layer_TF(Tensor_Order=4,
                                           Convolution_Subsection=Convolution_Shape_Encoder,
                                           Filter_Size=Filter_Size_Convolution_Encoder,
...
# =============================================================================
    ...
    Decoder_Reshape_Layer=Convolution_Layer_TF(Tensor_Order=4,
                                               Convolution_Subsection=Convolution_Shape_Encoder,
                                               Filter_Size=Filter_Size_Convolution_Encoder,
                                               Number_of_Filters=Number_of_Filters_Convolution_Decoder_Reshape,
                                               Convolution_Strides=Strides_Convolution_Decoder_Reshape,
                                               Weights_Initializer="glorot_uniform",
                                               Bias_Initializer="zeros",
...
#-------------------------Decoder-1st Stack of Layers-------------------------#
    ...
    Decoder_1st_Stack=Convolution_Layer_Transpose_TF(Tensor_Order=4,
                                                     Convolution_Transpose_Subsection=Convolution_Transpose_Shape_Decoder,
                                                     ...
                                                     Convolution_Transpose_Strides=Strides_Convolution_Transpose_Decoder,
                                                     Weights_Initializer="glorot_uniform",
                                                     Bias_Initializer="zeros",
...
#-------------------------Decoder-2nd Stack of Layers-------------------------#
    ...
    Decoder_2nd_Stack=Convolution_Layer_Transpose_TF(Tensor_Order=4,
                                                     Convolution_Transpose_Subsection=Convolution_Transpose_Shape_Decoder,
                                                     Filter_Size=Filter_Size_Convolution_Transpose_Decoder,
...
# =============================================================================
#     Decoder_3rd_Stack=Convolution_Layer_Transpose_TF(Tensor_Order=4,
#                                                      Convolution_Transpose_Subsection=Convolution_Transpose_Shape_Decoder,
#                                                      Filter_Size=Filter_Size_Convolution_Transpose_Decoder,
...
#---------------------------------Prediction Layer----------------------------#
    ...
    Neural_Network_Output=Convolution_Layer_TF(Tensor_Order=4,
                                               Convolution_Subsection=Convolution_Shape_Last,
                                               Filter_Size=Filter_Size_Convolution_Last,
                                               Number_of_Filters=Number_of_Filters_Convolution_Last,
                                               Convolution_Strides=Strides_Convolution_Last,
                                               Weights_Initializer="glorot_uniform",
                                               Bias_Initializer="zeros",
